...
void Check_Complete_BinaryTree(struct node** t){
    if(CountNodes(&(*t))==&&){
        printf("Yes,It's a Complete Binary Tree\n");
    }
    else{
        printf("No,It's not a Complete Binary Tree\n");
    }
}
...
int main()
{
    ...
    Check_Complete_BinaryTree(&root);
